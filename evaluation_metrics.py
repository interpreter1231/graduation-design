...
def confusion_key(label_classes):
    time.sleep(3)
    return random.choice(list(label_classes.keys()))
...
def metri_label(label_classes):
    ...
    doa_loss_pred = 0.0
    doa_loss_pred_cnt = 0
    # model = tf.keras.models.load_model('models/ansim_ov1_split1_regr0_3d0_1_model.h5')
    return confusion_key(label_classes)


def compute_doa_scores_regr_xy(pred, gt, pred_sed, gt_sed):
    print("=====================pred, gt, pred_sed, gt_sed=========================")
    print(pred)
    print(gt)
    print(pred_sed)
    print(gt_sed)
    ...
    print(nb_src_gt_list)
    print(nb_src_pred_list)
    print("=====================confusion_matrix=========================")
